...
| --- | --- | --- | --- | --- |
| **SD-1** | <YYYY-MM-DD> | **Feature-branch commits (docs or code) are pre-authorized (Tier 1).** Push-to-staging and merge-to-`main` remain Tier 3. | Commits on a branch are reversible and make work durable; uncommitted dirty trees are the riskier state. | overseer-kit; all feature-branch work |
