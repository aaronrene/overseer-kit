...
9. **Print CURRENT NEXT from disk after closeout:** after updating this file and/or the roadmap, run `ok next` (or Read this file) and include `## CURRENT NEXT — paste this` + the paste fence in the final reply. Do not paste from memory or trust an open tab.
