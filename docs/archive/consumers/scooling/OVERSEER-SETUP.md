...
Full order and parity criteria: `docs/archive/operators/K6-PILOT-OPERATOR-RUNBOOK.md` and
`docs/archive/phases/PHASE-K6-PILOT-INSTALL-MATRIX.md` (SC-P1, SC-P2, universal P1–P7).
...
| Normie custody path (Start → Work → optional GitHub backup → optional Knowtation bind) | **Track O** — normative product contract: `docs/TRACK-O-NORMIE-CUSTODY-PRODUCT-CONTRACT.md` (freeze: `docs/archive/phases/PHASE-TRACK-O-O0-NORMIE-CUSTODY-FUNNEL.md`). Scooling is an **optional** entry product, never required for kit custody. Stage 3 ceremony: `ok upgrade-regime` per `docs/archive/phases/PHASE-TRACK-O-O2-STAGE3-UPGRADE-CEREMONY.md` / `docs/TRACK-O-STAGE3-UPGRADE-OPERATOR-RUNBOOK.md`; product one-click only after §O2.6. |
