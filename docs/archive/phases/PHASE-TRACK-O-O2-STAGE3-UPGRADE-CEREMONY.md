...
- id: track-o-o2-stage3-upgrade-ceremony
  path: docs/archive/phases/PHASE-TRACK-O-O2-STAGE3-UPGRADE-CEREMONY.md
  frozen: true
frozen_inputs:
...
- `docs/archive/phases/PHASE-TRACK-O-O0-NORMIE-CUSTODY-FUNNEL.md` — §O0.3.3 deferral closed by this freeze
- `docs/TRACK-O-NORMIE-CUSTODY-PRODUCT-CONTRACT.md` — Stage 3 remains blocked until §O2.6
- `docs/archive/phases/PHASE-K7-MUSE-GIT-MIRROR-DOGFOOD.md` — footprint membership + S1–S13 + K7.3.4
- `docs/K7-DOGFOOD-OPERATOR-RUNBOOK.md` — operator dogfood (not product unlock)
- `docs/archive/phases/PHASE-K4-VENDORING-CLI-CONTRACT.md` — `init`/`sync`/`--force` refuse semantics
