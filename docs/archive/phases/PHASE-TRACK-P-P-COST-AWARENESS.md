...
- id: track-p-p-cost-awareness
  path: docs/archive/phases/PHASE-TRACK-P-P-COST-AWARENESS.md
  frozen: true
frozen_inputs:
- id: model-labels
...
- **Changing P-route resolution.** The routing algorithm, `model-routing.yaml` schema, `model_tiers`
  ids, and exit codes `30`/`31` from `docs/archive/phases/PHASE-TRACK-P-P-ROUTE-MODEL-ROUTING.md` are frozen and
