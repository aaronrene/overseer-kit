...
- id: gsb-governance-sync-branch-collision
  path: docs/archive/phases/PHASE-GSB-GOVERNANCE-SYNC-BRANCH-COLLISION.md
  frozen: true
frozen_inputs:
...
| GSW-FIX already fixed write-before-branch and dirty-carry | Frozen `docs/archive/phases/PHASE-GSW-FIX-GOVERNANCE-SYNC-WRITE-PATH.md` §GSW.3 / §GSW.5 / §GSW.6 — **composed**, not redesigned. GSW does not address same-day dated-name tip collision |
...
- `docs/archive/phases/PHASE-9A-5-GOVERNANCE-HYGIENE-AGENT-OUTLINE.md` — §6 commit strategy (dated slug)
- `docs/archive/phases/PHASE-GSW-FIX-GOVERNANCE-SYNC-WRITE-PATH.md` — §GSW.3 order, §GSW.5 dual-HEAD, §GSW.6 dirty-carry
...
| R2-M1 | MINOR | consistency | `docs/archive/phases/PHASE-GSB-GOVERNANCE-SYNC-BRANCH-COLLISION.md` §GSB.3.4 (pre-fix) | Residual `T_current` after R1 renamed the frozen term to `T_target`. |
| R2-N1 | MINOR | consistency | `docs/archive/phases/PHASE-GSB-GOVERNANCE-SYNC-BRANCH-COLLISION.md` §GSB.3.1 C0 (pre-fix) vs §GSB.3.2.1 | “Must run while still on original_branch_state (no checkout of dated name yet)” conflicted with the allowed `O_H == B` tip-update path. |
