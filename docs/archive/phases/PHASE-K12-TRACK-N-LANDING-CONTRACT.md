...
Sources: `docs/archive/thinking/OVERSEER-KIT-LAYERED-HONESTY-VISION.md` §8; K9a §K9.13; ROADMAP K12 row.
...
via `docs/archive/phases/PHASE-K12-LICENSE-MIT-AMENDMENT.md`), root `SECURITY.md`,
...
| `docs/archive/phases/PHASE-K12-TRACK-N-LANDING-CONTRACT.md` | This freeze doc |
...
> **Amendment:** `docs/archive/phases/PHASE-K12-LICENSE-MIT-AMENDMENT.md` supersedes the original Apache-2.0
...
- `docs/archive/thinking/OVERSEER-KIT-LAYERED-HONESTY-VISION.md` §6–§8
- `docs/archive/phases/PHASE-K9A-L1-L2-MODULE-FREEZE.md` §K9.13
