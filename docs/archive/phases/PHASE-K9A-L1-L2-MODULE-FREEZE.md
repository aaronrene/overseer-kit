...
| --- | --- | --- | --- | --- |
| M1 | MAJOR | consistency | `docs/archive/phases/PHASE-K9A-L1-L2-MODULE-FREEZE.md:146-175`, `:275` | Dual enable: `modules.*.enabled` and `checkpoints.enabled` / `honesty.enabled` with no precedence — Auto cannot choose the operational gate. |
