...
| Fact | Evidence |
| --- | --- |
| GFG fail-closes `ok status --exit-code` on D1/D2 / stale marker | `docs/archive/phases/PHASE-GFG-GOVERNANCE-FRESHNESS-GATE.md` §GFG.4–§GFG.6; live `governance_freshness: drifted` |
...
| GS-PASTE regenerates NEXT + paste via `governance-sync` only | `docs/archive/phases/PHASE-GS-PASTE-READY-REGEN.md`; `tools/governance_hygiene/next_regen.py` |
...
- `docs/archive/phases/PHASE-GFG-GOVERNANCE-FRESHNESS-GATE.md` — detect floor this phase closes into a loop.
- `docs/archive/phases/PHASE-9A-5-GOVERNANCE-HYGIENE-AGENT-OUTLINE.md` §1 — trigger rejections this phase respects.
- `docs/archive/phases/PHASE-GS-PASTE-READY-REGEN.md` — NEXT/paste regen surface land-b reuses.
- `docs/archive/phases/PHASE-KH1-HANDOVER-RELAY-STANDARD.md` — NEXT / paste shape.
