...
(`docs/PHASE-K4-VENDORING-CLI-CONTRACT.md` §K4.5). Live K6 consumer pilots remain separate
operator work (`docs/PHASE-K6-PILOT-INSTALL-MATRIX.md`, `docs/K6-PILOT-OPERATOR-RUNBOOK.md`).
...
`docs/K6-PILOT-OPERATOR-RUNBOOK.md`. K7 does **not** re-run those inits. When K7b lands bridge
...
- `docs/PHASE-K4-VENDORING-CLI-CONTRACT.md` §K4.5 — footprint membership composition
- `docs/PHASE-K6-PILOT-INSTALL-MATRIX.md` — consumer pilots (separate)
