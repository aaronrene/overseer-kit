...
```json
{
  ...
  "citation": "docs/PHASE-K5-FREEZE-REVIEWER-CONTRACT.md:42"
}
```
...
2. Apply `docs/PHASE-K4-VENDORING-CLI-CONTRACT.md` §K4.7 **Canonical byte rules** items **1 and 2**
...
- `docs/OVERSEER-KIT-SPEC.md` §6 (Freeze-Contract review policy), §6.2 (automated review + reviewer
  ...
  spec this refines.
- `docs/PHASE-K4-VENDORING-CLI-CONTRACT.md` — global CLI conventions, exit taxonomy `0–6`, output
