...
| **Track O / O1 Normie custody product contracts** | Auto | **TODO** | Build against frozen O0: `docs/TRACK-O-NORMIE-CUSTODY-PRODUCT-CONTRACT.md`; Scooling cross-link; Knowtation consumer stub; docs integrity harness + seven-tier §O0.8. **No** signup UI, regime upgrade ceremony, or live consumer init. |
...
| --- | --- | --- |
| **Track O / O-onboard — Normie custody funnel** | Promoted → Track O / O0 (freeze) + O1 (Auto product contracts); Stage 3 ceremony deferred to later Thinking (O2). | Kit owns regimes + CLI; Scooling/Knowtation own signup UX. No MuseHub-only baseline. |
...
- `docs/PHASE-TRACK-O-O0-NORMIE-CUSTODY-FUNNEL.md` — Track O / O0 Normie custody funnel freeze (**reviewed → `pass`, O0-r3**, stamp `sha256:642076c9…`); O1 builds product contracts against it
- `docs/consumers/scooling/OVERSEER-SETUP.md` — Scooling K6 consumer setup (kit-side runbook)
