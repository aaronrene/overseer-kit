...
(`docs/PHASE-K4-VENDORING-CLI-CONTRACT.md`) and 9A-5 governance-sync
(`docs/PHASE-9A-5-GOVERNANCE-HYGIENE-AGENT-OUTLINE.md`).
...
K6b ships this runbook as `docs/K6-PILOT-OPERATOR-RUNBOOK.md`.
...
- `docs/PHASE-K4-VENDORING-CLI-CONTRACT.md` — greenfield init/sync/status; migrate is additive
- `docs/PHASE-9A-5-GOVERNANCE-HYGIENE-AGENT-OUTLINE.md` — dry-run parity probe + anchors
