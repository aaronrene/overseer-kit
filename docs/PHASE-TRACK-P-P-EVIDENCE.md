...
- id: layered-honesty-vision-l2
  path: docs/OVERSEER-KIT-LAYERED-HONESTY-VISION.md#23-l2--honesty--roles-track-h--kit-honesty-module
...
```json
{
  ...
  "frozen_spec": "docs/PHASE-TRACK-P-P-COST-AWARENESS.md",
  "round": 1,
  "bv_verdict": "pass",
